                        ...
                        <form action="{{ route('admin.actualizar.socios', $soci->soco_codigo) }} " method="POST">
                            ...
                            <div class="form-group" style="">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control" style="width: 100%" id="grupo"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select class="form-control" style="width: 100%" id="subgrupo2" name="subgrupo">
                                        <option value="" disabled selected>Seleccione...</option>
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.crear.socios') }} " method="POST">
                        ...
                        <div class="form-group">
                            <label>Grupo de interés</label>
                            <div class="input-group">
                                <select class="form-control" style="width: 100%" id="grupointres" name="grupo"
                        ...
                        <div class="form-group">
                            <label>Subgrupo de interés</label>
                            <div class="input-group">
                                <select class="form-control" style="width: 100%" id="subgrupo" name="subgrupo">
                                    <option value="" disabled selected>Seleccione...</option>
