...
{{-- url({{ asset('/img/fonologin.jpg') }}) --}}
    style=" background-color: #515151;border-color: #515151; background:  url({{ asset('/img/fonologin.webp') }})  ;background-size:cover; background-repeat:repeat;background-attachment: fixed;background-position: center;">
    <section class="ftco-section" style="margin-right: 1%; display: flex; align-items:center;">
        <div class="container" style="background: rgba(255, 255, 255, 0.871);  border-radius: 50px; width:500px;">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center" style="border-radius: 50px; margin: 0 auto; margin-top:5%;">
                        <img src="{{ asset('/img/Logo-CFT-Estatal-Aysen.png') }}" alt="Imagen" class="img-fluid">
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-10 offset-md-3" style="background-color:;margin: 0 auto;">
                    <form action="{{ route('auth.ingresar') }}" class="signin-form" method="POST"
                        ...
                        <div class="form-group mb-1" style="margin-top:-5%; width:100%;">
                            ...
                            <input style="background-color:white; color:black; border: 1px solid rgb(231, 104, 0);"
                        ...
                        <div class="form-group">
                            <button type="submit" class="form-control btn rounded submit px-3"
                                style="background-color:rgb(89, 121, 186); color:white;margin-top:5%;">Ingresar</button>
                        </div>
                    </form>
                </div>
            </div>
